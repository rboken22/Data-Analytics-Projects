...
- [Deep Learning for Real Estate Price Prediction](/Deep%20Learning%20for%20Real%20Estate%20Price%20Prediction.ipynb): In this notebook, we predict home sale prices in King County, USA (including Seattle) for houses sold between May 2014 and May 2015 using a deep learning model with features such as number of bedrooms, bathrooms, view, and square footage.
...
- [Sentiment Analysis](/SentimentAnalysis_NGrams.ipynb): In this notebook, we perform Sentiment Polarity Analysis by preprocessing the data - converting to lowercase, removing punctuations, expanding contractions, etc. We also perform N-Gram analysis of reviews.
